Pod::Spec.new do |spec|
  spec.name = "MediaPipeTasksVision"
  spec.version = ENV.fetch("POD_VERSION", "0.10.24.1")
  spec.summary = "MediaPipe Tasks Vision built from upstream v0.10.24"
  ...
  spec.source = {
    :http => "https://github.com/ryjen/mediapipe/releases/download/#{tag}/MediaPipeTasksVision-#{spec.version}.tar.gz"
  }

  spec.vendored_frameworks = "frameworks/MediaPipeTasksVision.xcframework"
  spec.dependency "MediaPipeTasksCommon", "= #{spec.version}"
  spec.libraries = "c++"
